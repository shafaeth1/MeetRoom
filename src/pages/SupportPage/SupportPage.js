            ...
            <div className="flex flex-wrap items-center">
                ...
                <div className="grow-0 shrink-0 basis-auto w-full lg:w-7/12 md:px-6">
                    <div className="flex mb-12 border-b-2 pb-2">
                        <div className="shrink-0">
                            <div className="p-4 rounded-md shadow-lg">
                                <svg className="w-10 h-10 text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <div className="flex mb-12 border-b-2 pb-2">
                        <div className="shrink-0">
                            <div className="p-4 rounded-md shadow-lg">
                                <svg className="w-10 h-10 text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                    ...
                    <div className="flex border-b-2 pb-2">
                        <div className="shrink-0">
                            <div className="p-4 rounded-md shadow-lg">
                                <svg className="w-10 h-10 text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 544 512">
