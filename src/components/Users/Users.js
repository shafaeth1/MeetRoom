...
const Users = () => {
    return (
        ...
        <div className="flex justify-between gap-2 py-2">
            <p className='text-gray-200 text-sm font-semibold'><i className="fal fa-users font-semibold px-1"></i>Perticipets</p>
            <p className='text-gray-200 text-sm font-semibold'><i className="fal fa-users font-semibold px-1"></i>Invite</p>
        </div>
