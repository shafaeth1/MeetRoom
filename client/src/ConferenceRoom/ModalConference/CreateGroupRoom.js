...
const CreateGroupRoom = () => {
    return (
        <div className=' items-center justify-center'>
            <label for="my-modal-3" className="hover:cursor-pointer"><i className="fas fa-video-plus font-bold text-3xl bg-clock bg-transparent border border-gray-300 p-2"></i></label>

            <input type="checkbox" id="my-modal-3" className="modal-toggle" />
            
            <div className="modal modal-bottom sm:modal-middle  ">
                <div className="modal-box bg-chat h-auto  mx-auto  ">
                    <h2 className="text-center text-2xl divide-y">Group Video Calling</h2>
