            ...
            <div className="flex flex-col-reverse lg:flex-row items-center mt-4">
                <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 md:px-6">
                    <div className="flex mb-12 border-b-2 pb-2">
                        <div className="shrink-0">
                            <div className="p-4 rounded-md shadow-lg">
                                <svg className="w-8 h-8 text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <div className="grow mx-4">
                            <p className="font-semibold uppercase mb-1 text-lg">Support 24/7</p>
                    ...
                    <div className="flex mb-12 border-b-2 pb-2">
                        ...
                        <div className="grow mx-4">
                            <p className="font-semibold uppercase mb-1 text-lg">Safe and solid</p>
                    ...
                    <div className="flex mb-12 border-b-2 pb-2">
                        <div className="shrink-0">
                            <div className="p-4 rounded-md shadow-lg">
                                <svg className="w-8 h-8 text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        ...
                        <div className="grow mx-4">
                            <p className="font-semibold uppercase mb-1 text-lg">Extremely fast</p>
                    ...
                    <div className="flex border-b-2 pb-2">
                        <div className="shrink-0">
                            <div className="p-4 rounded-md shadow-lg">
                                <svg className="w-8 h-8 text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 544 512">
                        ...
                        <div className="grow mx-4">
                            <p className="font-semibold uppercase mb-1 text-lg">Live analytics</p>
