                        ...
                        return (<>
                            ...
                            <div className='flex items-center py-1 justify-start message' id={username === messageContent.author ? "you" : "other"}>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm bg-slate-600 p-1 rounded message-content'>{messageContent.message}</p>
                            ...
                            <div >
                                ...
                                <p className='text-sm bg-slate-600 p-1 rounded'>{messageContent.message}</p>
